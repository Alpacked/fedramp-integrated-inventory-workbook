...
def send_email_with_attachment(file_path):
    ...
    email = os.environ.get("RECIPIENT")

    SENDER = f"Sender Name <{email}>"
    RECIPIENT = email
    ...
    <body>
    <h1>Hello!</h1>
    <p>Please see the attached file for a FedRamp inventory document, generated by <a href="https://github.com/aws-samples/fedramp-integrated-inventory-workbook">fedramp-integrated-inventory-workbook<a>.</p>
    </body>
    </html>
    """
